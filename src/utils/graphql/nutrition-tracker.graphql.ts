...
export const NUTRITION_TRACKED_DAYS_BY_USER: DocumentNode = gql`
...
export const NUTRITION_TRACKED_DAYS_SUMMARY_BY_USER: DocumentNode = gql`
...
export const CREATE_USER_NUTRITION_TRACKED_DAY: DocumentNode = gql`
...
export const DELETE_USER_NUTRITION_TRACKED_DAY: DocumentNode = gql`
...
export const UPDATE_USER_NUTRITION_TRACKED_DAY: DocumentNode = gql`
...
export const UPDATE_USER_NUTRITION_TRACKED_DAYS: DocumentNode = gql`
...
export const UPDATE_USER_NUTRITION_TRACKED_DAYS_SUMMARY: DocumentNode = gql`
